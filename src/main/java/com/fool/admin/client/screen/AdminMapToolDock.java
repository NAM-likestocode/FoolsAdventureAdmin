...
public class AdminMapToolDock extends AbstractWidget {
    ...
    public static AdminMapToolDock create(
        ...
        if (tab == AdminTab.BOSSES) {
            dock.addTool(innerX, innerY, buttonWidth, "foolsadmin.admin.tool.spawn", AdminMapTool.SET_SPAWN, activeTool, onToolSelected);
            dock.addTool(innerX + buttonWidth + BUTTON_GAP, innerY, buttonWidth, "foolsadmin.admin.tool.paint", AdminMapTool.PAINT_ZONE, activeTool, onToolSelected);
            innerY += BUTTON_HEIGHT + BUTTON_GAP;
            dock.addTool(innerX, innerY, buttonWidth, "foolsadmin.admin.tool.erase", AdminMapTool.ERASE_ZONE, activeTool, onToolSelected);
            dock.addTool(innerX + buttonWidth + BUTTON_GAP, innerY, buttonWidth, "foolsadmin.admin.tool.attract", AdminMapTool.SET_ATTRACTION, activeTool, onToolSelected);
            innerY += BUTTON_HEIGHT + BUTTON_GAP;
            dock.addTool(innerX, innerY, dockWidth - INNER_PADDING * 2, "foolsadmin.admin.tool.pan", AdminMapTool.PAN, activeTool, onToolSelected);
        } else {
            dock.addTool(innerX, innerY, buttonWidth, "foolsadmin.admin.tool.spawn", AdminMapTool.SET_SPAWN, activeTool, onToolSelected);
            dock.addTool(innerX + buttonWidth + BUTTON_GAP, innerY, buttonWidth, "foolsadmin.admin.tool.waypoint", AdminMapTool.ADD_WAYPOINT, activeTool, onToolSelected);
            innerY += BUTTON_HEIGHT + BUTTON_GAP;
            dock.addTool(innerX, innerY, dockWidth - INNER_PADDING * 2, "foolsadmin.admin.tool.pan", AdminMapTool.PAN, activeTool, onToolSelected);
        }
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(
                ...
                Component.translatable("foolsadmin.admin.inspector.tools"),
                getX() + INNER_PADDING,
    ...
    protected void updateWidgetNarration(NarrationElementOutput output) {
        output.add(net.minecraft.client.gui.narration.NarratedElementType.TITLE, Component.translatable("foolsadmin.admin.inspector.tools"));
    }
}
