...
import com.fool.adventure.admin.map.MapTileMath;
...
public class AdminMapWidget extends AbstractWidget {
    ...
    protected void updateWidgetNarration(NarrationElementOutput output) {
        output.add(net.minecraft.client.gui.narration.NarratedElementType.TITLE, Component.translatable("foolsadventure.admin.map.narration"));
    }
